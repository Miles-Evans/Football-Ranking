...
fcs_teams = {
    ...
    'Cal Poly', 'Campbell', 'Central Arkansas', 'Central Connecticut', 'Charleston Southern', 'Chattanooga',
    'The Citadel', 'Colgate', 'Davidson', 'Delaware State', 'Drake', 'Duquesne', 'East Tennessee State',
    'East Texas A&M', 'Eastern Illinois', 'Eastern Kentucky', 'Eastern Washington', 'Elon', 'Florida A&M',
    'Fordham', 'Furman', 'Gardner-Webb', 'Georgetown', 'Grambling', 'Hampton', 'Holy Cross', 'Houston Christian',
    'Howard', 'Idaho', 'Idaho State', 'Illinois State', 'Indiana State', 'Jackson State', 'Lafayette',
    'Lamar', 'Lehigh', 'Lindenwood', 'LIU', 'Maine', 'Marist', 'McNeese', 'Mercer', 'Merrimack',
    'Mississippi Valley State', 'Monmouth', 'Montana', 'Montana State', 'Morehead State', 'Morgan State',
    'Murray State', 'New Hampshire', 'Nicholls', 'Norfolk State', 'North Alabama', 'North Carolina A&T',
    'North Carolina Central', 'North Dakota', 'Northern Arizona', 'Northern Colorado', 'Northern Iowa',
    'Northwestern State', 'Portland State', 'Prairie View A&M', 'Presbyterian', 'Rhode Island', 'Richmond',
    'Robert Morris', 'Sacred Heart', 'St. Thomas-Minnesota', 'Samford', 'San Diego', 'South Carolina State',
    'South Dakota', 'South Dakota State', 'Southeast Missouri State', 'Southern', 'Southern Illinois',
    'Southern Utah', 'Stephen F. Austin', 'Stetson', 'Stonehill', 'Stony Brook', 'Tarleton State', 'Tennessee State',
    'Tennessee Tech', 'Texas Southern', 'Towson', 'UC Davis', 'UT Martin', 'Utah Tech', 'UT Rio Grande Valley',
    'Valparaiso', 'Villanova', 'VMI', 'Wagner', 'Weber State', 'Western Carolina', 'Western Illinois',
...
fcs_aliases = {
    ...
    'shu': 'Sacred Heart',
    'st. thomas-minnesota': 'St. Thomas-Minnesota',
    'stmn': 'St. Thomas-Minnesota',
    'samford': 'Samford',
    'sam': 'Samford',
    'san diego': 'San Diego',
    'usd': 'San Diego',
